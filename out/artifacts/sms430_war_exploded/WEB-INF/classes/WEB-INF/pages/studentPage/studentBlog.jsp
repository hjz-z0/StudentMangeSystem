    ...
    <script type="text/javascript">
        function initTable() {
            ...
            $("#cusTable").bootstrapTable({
                ...
                url:"<%=basePath%>/blog/findAllByPageByName.do",//要请求数据的文件路径
        ...
        function actionFormatter(value,row,index){
            let id=value;
            let result="";
            result+="<a class=\"btn btn-info btn-xs\" onclick=\"showDetail("+id+")\">更新</a>&nbsp;";
        ...
        function showDetail(bid){
            location.href='<%=basePath%>/blog/toStudentBlogDetail.do?bid='+bid;
        ...
        function deleteBlog(){
            ...
            //从隐藏表单域取出sid值
            let bid=$('#del_id').val();
            location.href='<%=basePath%>/blog/deleteStudentBlog.do?bid='+bid;
        }
